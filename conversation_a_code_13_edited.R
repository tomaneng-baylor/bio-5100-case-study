...
ggplot(data = tsne_data, aes(x = V1, y = V2, color = as.factor(cluster))) +
  geom_point() +
  ggtitle("t-SNE Visualization of Pancreatic Cancer Cells") +
  theme_minimal() +
  scale_color_discrete(name = "Cluster")

# Save the visualization to a .PNG file. (This was added manually at the
# conclusion of this project.)

ggsave(filename = "example_t-SNE_plot_with_clustering.PNG")