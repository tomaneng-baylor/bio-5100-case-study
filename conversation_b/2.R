...
tsne_df$group <- gsub("sgRAI14(3)-6 collagen I_normalized", "sgRAI14-6 COL1", tsne_df$group)
tsne_df$group <- gsub("sgRAI14(3)-6 fibronectin_normalized", "sgRAI14-6 FBN", tsne_df$group)
tsne_df$group <- gsub("sgRAI14(3)-6 plastic_normalized", "sgRAI14-6 PL", tsne_df$group)
